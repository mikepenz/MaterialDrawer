 ...
 */
public class CustomProfileDrawerItem extends AbstractDrawerItem<CustomProfileDrawerItem> implements IProfile<CustomProfileDrawerItem>, Tagable<CustomProfileDrawerItem>, Typefaceable<CustomProfileDrawerItem> {
    ...
    @Override
    public CustomProfileDrawerItem withIcon(Drawable icon) {
        this.icon = new ImageHolder(icon);
        return this;
    }

    @Override
    public CustomProfileDrawerItem withIcon(@DrawableRes int iconRes) {
        this.icon = new ImageHolder(iconRes);
        return this;
    }

    @Override
    public CustomProfileDrawerItem withIcon(Bitmap iconBitmap) {
        this.icon = new ImageHolder(iconBitmap);
        return this;
    }

    @Override
    public CustomProfileDrawerItem withIcon(IIcon icon) {
        this.icon = new ImageHolder(icon);
        return this;
    }

    @Override
    public CustomProfileDrawerItem withIcon(String url) {
        this.icon = new ImageHolder(url);
        return this;
    }

    @Override
    public CustomProfileDrawerItem withIcon(Uri uri) {
        this.icon = new ImageHolder(uri);
        return this;
    }

    public CustomProfileDrawerItem withName(String name) {
        this.name = new StringHolder(name);
        return this;
    }

    public CustomProfileDrawerItem withEmail(String email) {
        this.email = new StringHolder(email);
        return this;
    }

    public CustomProfileDrawerItem withNameShown(boolean nameShown) {
        this.nameShown = nameShown;
        return this;
    }

    public CustomProfileDrawerItem withSelectedColor(@ColorInt int selectedColor) {
        this.selectedColor = ColorHolder.fromColor(selectedColor);
        return this;
    }

    public CustomProfileDrawerItem withSelectedColorRes(@ColorRes int selectedColorRes) {
        this.selectedColor = ColorHolder.fromColorRes(selectedColorRes);
        return this;
    }

    public CustomProfileDrawerItem withTextColor(@ColorInt int textColor) {
        this.textColor = ColorHolder.fromColor(textColor);
        return this;
    }

    public CustomProfileDrawerItem withTextColorRes(@ColorRes int textColorRes) {
        this.textColor = ColorHolder.fromColorRes(textColorRes);
        return this;
    }

    public CustomProfileDrawerItem withTypeface(Typeface typeface) {
    ...
    public void bindView(RecyclerView.ViewHolder holder) {
        ...
        UIUtils.setBackground(viewHolder.view, UIUtils.getCompatDrawable(ctx, DrawerUIUtils.getSelectableBackground(ctx)));
