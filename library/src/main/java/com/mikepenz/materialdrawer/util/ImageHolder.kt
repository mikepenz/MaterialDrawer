...
class ImageHolder {
    ...
    companion object {
         ...
         * @param tint
         */
        fun applyDecidedIconOrSetGone(imageHolder: ImageHolder?, imageView: ImageView?, iconColor: ColorStateList, tint: Boolean) {
            if (imageHolder != null && imageView != null) {
                val drawable = ImageHolder.decideIcon(imageHolder, imageView.context, iconColor, tint)
                when {
                    drawable != null -> {
